...
class SynapticResonator:
    ...
    # ---------------------------------------------------------
    def resonate(self, stimulus_value: float) -> Dict[str, Any]:
        """
        ICS-V2 flow:
          2340 synapses fire → grouped → pyramid → final verdict
        """
        ...
        return {
            "synaptic_verdict": final_verdict,
